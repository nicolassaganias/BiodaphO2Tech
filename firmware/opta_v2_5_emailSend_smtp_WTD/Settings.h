...
const unsigned long NTP_SYNC_INTERVAL = 6 * 60 * 60 * 1000;  // 30 minutos en milisegundos con 1 min de delay delay para que se desfase del envío de mail
const unsigned long PRINT_DELAY = 5000;                      //5 seconds
const unsigned long EMAIL_INTERVAL = 60 * 60 * 1000;         // 1 hour in milliseconds
unsigned long last_print, lastStatusEmailSent, lastEmailSent, lastNTPUpdate = 0;
