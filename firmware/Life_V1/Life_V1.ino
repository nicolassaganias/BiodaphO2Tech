...
/* -------------------------------------------------------------------------- */    
  ...
  if (!client.connected()) {
    ...
    if (currentMillis - lastReadingMillis >= interval) {
      ...
      float lec_AS_DO1 = escalarValores(lecturaAnalog(0), 4.0, 20.0, 0.0, 32.0);
      publish(RES_AS_DO1, lec_AS_DO1, PubWrite);
      delay(30);

      float lec_AS_PH1 = escalarValores(lecturaAnalog(1), 4.0, 20.0, 0.0, 14.0);
      publish(RES_AS_PH1, lec_AS_PH1, PubWrite);
      delay(30);

      float lec_AS_EC1 = escalarValores(lecturaAnalog(2), 4.0, 20.0, 0.0, 25000.0);
      publish(RES_AS_EC1, lec_AS_EC1, PubWrite);
      delay(30);

      float lec_AS_DO2 = escalarValores(lecturaAnalog(3), 4.0, 20.0, 0.0, 32.0);
      publish(RES_AS_DO2, lec_AS_DO2, PubWrite);
      delay(30);

      float lec_AS_PH2 = escalarValores(lecturaAnalog(4), 4.0, 20.0, 0.0, 14.0);
      publish(RES_AS_PH2, lec_AS_PH2, PubWrite);
      delay(30);

      float lec_AS_EC2 = escalarValores(lecturaAnalog(5), 4.0, 20.0, 0.0, 25000.0);
      publish(RES_AS_EC2, lec_AS_EC2, PubWrite);
      delay(30);

      float lec_SM7020_1 = escalarValores(lecturaAnalog(6), 4.0, 20.0, 0.1, 75.0); // Caudalímetro IFM SM7020 1
      ...
      float lec_TSS_MLSS = analogRead(A5) * ((4000.0 - 0.0) / 65535.0) + 0.0; // Turbidímetro con módulo adaptador 0..10v
      publish(RES_TSS_MLSS, lec_TSS_MLSS, PubWrite);
      delay(30);

      // El A6 queda desconectado

      float lec_SM_9000 = analogRead(A7) * ((300.0 - 5.0) / 65535.0) + 5.0; // Caudalímetro IFM SM9000
      publish(RES_SM_9000, lec_SM_9000, PubWrite);
      delay(30);


      // Armar string separado por comas
      String all_readings = String(lec_AS_DO1, 1) + "," +
                            String(lec_AS_PH1, 1) + "," +
                            String(lec_AS_EC1, 1) + "," +
                            String(lec_AS_DO2, 1) + "," +
                            String(lec_AS_PH2, 1) + "," +
                            String(lec_AS_EC2, 1) + "," +
                            String(lec_SM7020_1, 1) + "," +
                            String(lec_SM7020_2, 1) + "," +
                            String(lec_SM_9000, 1) + "," +
                            String(lec_TSS_MLSS, 1);
      ...
      Serial.print("DO Atlas Scientific 1: ");        Serial.print(lec_AS_DO1, 2);       Serial.println(" mg/L");
      Serial.print("PH Atlas Scientific 1: ");        Serial.print(lec_AS_PH1, 2);       Serial.println("");
      Serial.print("EC Atlas Scientific 1: ");        Serial.print(lec_AS_EC1, 2);       Serial.println(" mS/cm");
      Serial.print("DO Atlas Scientific 2: ");        Serial.print(lec_AS_DO2, 2);       Serial.println(" mg/L");
      Serial.print("PH Atlas Scientific 2: ");        Serial.print(lec_AS_PH2, 2);       Serial.println("");
      Serial.print("EC Atlas Scientific 2: ");        Serial.print(lec_AS_EC2, 2);       Serial.println(" mS/cm");
      Serial.print("Caudalimetro SM7020 1: ");        Serial.print(lec_SM7020_1, 2);     Serial.println(" L/min");
      Serial.print("Caudalimetro SM7020 2: ");        Serial.print(lec_SM7020_2, 2);     Serial.println(" L/min");
      Serial.print("Turbidímetro: ");                 Serial.print(lec_TSS_MLSS, 2);     Serial.println(" NTU");
      Serial.print("Caudalimetro SM9000: ");          Serial.print(lec_SM_9000, 2);      Serial.println(" L/min");
      Serial.println("================================");
