...
// device id
#define DISSOLVE_OXYGEN_SENSOR "OXQ03" // must need an unique id for oxygen sensor
#define CONDUCTIVITY_SENSOR "ECQ03"    // must need an unique id for conductivity sensor
#define PH_SENSOR "PHQ03"              // must need an unique id for pH sensor
