...
// device id
#define DISSOLVE_OXYGEN_SENSOR "OXQ01" // must need an unique id for oxygen sensor
#define CONDUCTIVITY_SENSOR "ECQ01"    // must need an unique id for conductivity sensor
#define PH_SENSOR "PHQ01"              // must need an unique id for pH sensor
