...
// device id
#define DISSOLVE_OXYGEN_SENSOR "OXQ02" // must need an unique id for oxygen sensor
#define CONDUCTIVITY_SENSOR "ECQ02"    // must need an unique id for conductivity sensor
#define PH_SENSOR "PHQ02"              // must need an unique id for pH sensor
